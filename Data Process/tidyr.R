...
## Do not modify this line!
t1_longer<-t1 %>%
  select(Q2,Q3,Q7,Q8,Q11,Q25,Q13:Q13_F) %>%
  pivot_longer(cols=starts_with('Q13'),names_to="cases",values_to="comments",values_drop_na=TRUE)
...
separate_drop_redundant<-t1_longer_rename%>%
  separate(cases,into=c('case_name','category'),fill="right") %>%
