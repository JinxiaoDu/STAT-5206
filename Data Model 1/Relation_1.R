...
# are forgetting faster and faster. For a particular year, say б░1883,б▒ they
# calculated the proportion of all terms published in each year between 1875
# and 1975 that were б░1883б▒. They reasoned that this proportion is a measure of
...
#     9 1817   1708          1          1
#    10 1817   1713          1          1
#    # бн with 53,383 more rows
## Do not modify this line!
library(readr)
terms_mentions<-read_tsv("data/mentions_yearly_counts.tsv",col_names=c("term","year","n_mentions","book_count"),
...
#     9  1563         213843              931                1
#    10  1564          70755              387                1
#    # бн with 415 more rows
## Do not modify this line!
total_mentions<-read_csv("data/yearly_total_counts.csv",col_names=c("year","total_mentions","total_page_count","total_book_count"),
...
#    # A tibble: 0 x 4
#    # бн with 4 variables: term <chr>, year <int>, n_mentions <int>,
#    # book_count <int>
## Do not modify this line!
diagnosis<-terms_mentions %>%
  anti_join(mentions,by=c("term","year","n_mentions","book_count"))
diagnosis
...
library(ggplot2)
library(scales)
paper_figure<-ggplot(examples_mention_counts,mapping=aes(x=year,y=frac_total,color=term))+
  geom_line()+
  scale_y_continuous(label = percent)+
  coord_cartesian(xlim=c(1850,2012))+
  labs(title="Are we forgetting the past faster?",x="Year",y="Frequency of mention of each term",color="Term")+
  theme_light()
