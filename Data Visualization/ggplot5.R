...
#     9 AE    ARE   Uni# HW6: ggplot_nations
#'
# In this exercise, you have to recreate the figures found at
# the left of the instructions.
# We suggest functions you can use to create the plots, but
...
## Do not modify this line!
g1<-ggplot(nations)+
  geom_boxplot(aes(region,life_expect))+
  coord_flip()+
...
## Do not modify this line!
g3<-ggplot(nations)+
  geom_point(aes(gdp_percap,life_expect),alpha = 0.5,stroke = 0)+
...
g4<-g3+
  scale_x_log10()+
  geom_smooth(aes(gdp_percap,life_expect),se=F)
