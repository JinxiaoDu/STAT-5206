...
library(scales)
diamonds
g1<-ggplot(data=diamonds,aes(price,fill=cut))+
...
## Do not modify this line!
g2<-ggplot(diamonds,aes(price,color=cut))+
...
## Do not modify this line!
g3<-ggplot(diamonds,aes(carat,price,color=cut))+
  geom_point()+
  geom_smooth(se=F)+
...
## Do not modify this line!
g4<-ggplot(diamonds,aes(carat,price,color=cut))+
  geom_point()+
...
## Do not modify this line!
g5<-ggplot(diamonds,aes(color,price))+
  geom_boxplot()+
  scale_y_log10()+
...
#'
## Do not modify this line!
g6<-ggplot(diamonds,aes(color,price))+
  geom_violin()+
  scale_y_log10()+
  facet_wrap(~clarity)+
