...
library(ggplot2)
g1<-ggplot(iris,aes(Sepal.Length,Petal.Length,color=iris$Species))+
  geom_point()+
...
## Do not modify this line!
g4<-g3+
  geom_point(aes(Sepal.Length[15],Petal.Length[15]),pch=17,col="black",cex=3)
...
## Do not modify this line!
g5<-g4+
  geom_text(aes(Sepal.Length[15],Petal.Length[15]),label = "This is the iris with the longest sepal\n among the setosa species.",
            col = "black",nudge_x = 1)
